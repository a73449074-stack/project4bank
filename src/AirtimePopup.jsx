...
export default function AirtimePopup({ onClose, user }) {
  ...
  return (
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
      <div className="glassy-popup rounded-xl shadow-2xl p-6 w-96 max-w-full text-gray-900 relative animate-fade-in border border-blue-200/40">
        ...
        <div className="font-bold text-lg mb-2 text-center">Buy Airtime</div>
        <form onSubmit={handleSubmit} className="flex flex-col gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <label htmlFor="intl-airtime" className="text-xs">Buy International Airtime</label>
          </div>
